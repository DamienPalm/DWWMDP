...
<form action="" method="get">
    <input type="submit" class="btn btn-secondary" value="Tesla" name="Tesla" />
    <input type="submit" class="btn btn-secondary" value="RolceRoyce" name="RolceRoyce" />
    <input type="submit" class="btn btn-secondary" value="Lamborghini" name="Lamborghini">
</form>
