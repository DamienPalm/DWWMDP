                            ...
                            echo '<tbody>';
                                while ($row = mysqli_fetch_array($result)) {
                                    echo '<tr>';
                                        ...
                                        echo '<td>' . $row["role"] . '</td>';
                                        echo '<td>';
                                            echo '<a href="read.php?id=' . $row["id"] . '"class="mr-3" title="vue"
                                            data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo '<a href="update.php?id=' . $row["id"] . '"class="mr-3" title="mise à jour"
                                            data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo '<a href="delate.php?id=' . $row["id"] . '"class="mr-3" title="supprimer"
